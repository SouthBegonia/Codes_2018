/*
程序功能：加一的记忆训练。记忆多个数值，输入这些数值加一后的值。可以键入关卡数，自选等级，每次完成一个关卡打印答题对错，最终统计总答题情况及全部关卡答题情况。
思路：键入关卡数需要动态分配储存空间，即calloc()函数。
*/
#include<stdio.h>
#include<stdlib.h>
#include<time.h>
...
int main()
{
	...
	score = (int *)calloc(max_stage, sizeof(int));		//动态分配储存空间(强制转换)
